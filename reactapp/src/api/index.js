...
import checkoutComPayment from './cart/checkoutComPlaceOrder';
...
import { applyGiftCardToCart, removeGiftCardFromCart } from './cart/giftCard';
import applyStoreCredit from './cart/storeCredit/applyStoreCredit/applyStoreCredit';
import removeStoreCredit from './cart/storeCredit/removeStoreCredit/removeStoreCredit';
...
import getIsEmailPresent from './cart/getIsEmailPresent';
import getGiftCardBalance from './cart/getGiftCardBalance';
import fetchCountryRegion from './countries/fetchCountryRegion';
import getValidateMerchant from './cart/applePayPlaceOrder/validateMerchant';
import placeOrderApple from './cart/applePayPlaceOrder/placeOrder';

export const fetchCountryRegionRequest = fetchCountryRegion;
...
export const checkoutComPaymentMethodRequest = checkoutComPayment;
...
export const applyGiftCardToCartRequest = applyGiftCardToCart;

export const removeGiftCardFromCartRequest = removeGiftCardFromCart;

export const applyStoreCreditRequest = applyStoreCredit;

export const removeStoreCreditRequest = removeStoreCredit;

export const getIsEmailPresentRequest = getIsEmailPresent;

export const getGiftCardBalanceRequest = getGiftCardBalance;

export const getValidateMerchantRequest = getValidateMerchant;

export const placeOrderAppleRequest = placeOrderApple;
